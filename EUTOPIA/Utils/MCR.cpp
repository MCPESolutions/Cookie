...
ScreenContext* MCR::D3DCTX = nullptr;
...
LevelRenderer* MCR::levelrenderer = nullptr;
Font* MCR::mcFont = nullptr;
Vec3<float> MCR::origin;
float MCR::deltaTime = 0.016f;
std::vector<MCR::Draw3dData> MCR::quad3dRenderList;
std::vector<MCR::Draw3dData> MCR::line3dRenderList;
...
void MCR::onRenderWorld(LevelRenderer* levelRenderer, ScreenContext* sct) {
...
void MCR::setColor(const UIColor& color) {
 ...
 void MCR::drawText(const Vec2<float>& textPos, const std::string& textStr, const UIColor& color,
                   float textSize) {
...
void MCR::drawTextInWorld(const Vec3<float>& pos, const std::string& textStr,
 ...
 void MCR::drawQuad(const Vec2<float>& p1, const Vec2<float>& p2, const Vec2<float>& p3,
 ...
 void MCR::drawImage(mce::TexturePtr& texture, Vec2<float> const& pos, Vec2<float> const& size,
...
void MCR::drawItem(const Vec2<float>& pos, ItemStack* itemStack, float scale,
                   float opacity) {
 ...
 void MCR::drawBox3dFilled(const AABB& aabb, const UIColor& color, const UIColor& lineColor,
                           float scale) {
 ...
 void MCR::drawBoxFilledPre(const Vec3<float>& p1, const Vec3<float>& p2, const UIColor& color,
 ...
 void MCR::drawBoxFilled(const Vec3<float>& blockPos, const UIColor& color,
                           const UIColor& lineColor) {
...
void MCR::drawBox3dFilledRotation(const AABB& aabb, const UIColor& color, const UIColor& lineColor,
...
void MCR::drawBox3dFilledRotP(const Vec3<float>& center, const Vec3<float>& halfSize,
 ...
 void MCR::drawBox3dFilledRotP_BottomCenter(const Vec3<float>& center, const Vec3<float>& halfSize,
                                            float pitchRad, float yawRad, const UIColor& color,
                                            const UIColor& lineColor) {
     float cp = cosf(pitchRad), sp = sinf(pitchRad);
     float cy = cosf(yawRad), sy = sinf(yawRad);
 ...
 void MCR::drawBox3dFilledRotP_TopCenter(const Vec3<float>& center, const Vec3<float>& halfSize,
                                         float pitchRad, float yawRad, const UIColor& color,
                                         const UIColor& lineColor) {
     float cp = cosf(pitchRad), sp = sinf(pitchRad);
     float cy = cosf(yawRad), sy = sinf(yawRad);
 ...
 void MCR::drawLine3d(const Vec3<float>& start, const Vec3<float>& end, const UIColor& color) {
     line3dRenderList.push_back(Draw3dData(start.sub(origin), color));
     line3dRenderList.push_back(Draw3dData(end.sub(origin), color));
 }

 void MCR::drawCircle3d(const Vec3<float>& center, float radius, const UIColor& color,
                        int segments) {
     if(segments < 3)
         segments = 3;
 ...
 void MCR::drawCylinder3d(const Vec3<float>& baseCenter, float radius, float height,
 ...
 void MCR::drawSphere3d(const Vec3<float>& center, float radius, const UIColor& color,
                        int segments) {
     if(segments < 6)
         segments = 6;
 ...
 void MCR::drawSphere3dFilled(const Vec3<float>& center, float radius, const UIColor& color,
 ...
 void MCR::drawCylinder3dFilled(const Vec3<float>& baseCenter, float radius, float height,
 ...
 void MCR::drawPlayerModel(const Vec3<float>& position, float pitch, float yaw,
...
void MCR::drawWings(const Vec3<float>& center, float yaw, float wingSpan, float animationTime,
                          const UIColor& color, const UIColor& lineColor) {
     float yawRad = yaw * PI / 180.f;
