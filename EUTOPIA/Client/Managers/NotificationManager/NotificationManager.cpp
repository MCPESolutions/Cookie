...
void NotificationManager::Render() {
	...
	for (int i = 0; i < notifList.size(); i++) {
        ...
        D2D::fillRoundedRectangle(shadowRect, UIColor(0, 0, 0, (int)(50 * alpha)),
                                         cornerRadius);

		// Draw background with subtle gradient
        D2D::fillRoundedRectangle(rectPos, UIColor(30, 30, 35, (int)(220 * alpha)),
                                         cornerRadius);  // Dark base
		Vec4<float> gradientRect = Vec4<float>(rectPos.x, rectPos.y, rectPos.z, rectPos.y + 2.f);
        D2D::fillRoundedRectangle(gradientRect, UIColor(50, 50, 55, (int)(100 * alpha)),
        ...
        D2D::drawText(textPos, message, UIColor(255, 255, 255, (int)(255 * alpha)),
                             textSize);
