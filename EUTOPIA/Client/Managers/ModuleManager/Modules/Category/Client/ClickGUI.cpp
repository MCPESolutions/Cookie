    ...
    for(auto& window : windowList) {
        ...
        Vec4<float> hRectPos =
            Vec4<float>(window->pos.x, window->pos.y,
                        window->pos.x + (int)(195 * fontPercent) + (textPaddingX * 2.f),
        ...
        Vec2<float> hTextPos = Vec2<float>(
            ...
            hRectPos.y +
                (hRectPos.w - hRectPos.y - D2D::getTextHeight(window->name, textSize)) /
                    2.f);
        ...
        D2D::drawText(hTextPos, windowName, UIColor(255, 255, 255), textSize);

        D2D::fillRectangle(hRectPos,
        ...
        if(window->extended) {
            ...
            for(auto& mod : window->moduleList) {
                ...
                Vec2<float> colonPos = Vec2<float>(
                    mRectPos.z - textPaddingX - D2D::getTextWidth(":", textSize),
                    mRectPos.y +
                        (mRectPos.w - mRectPos.y - D2D::getTextHeight(":", textSize)) / 2.f);
                    ...
                    for(auto& setting : mod->getSettingList()) {
                        ...
                        switch(setting->type) {
                            ...
                            case SettingType::KEYBIND_S: {
                                ...
                                std::transform(settingName.begin(), settingName.end(),
                                               settingName.begin(), ::tolower);
                                ...
                                D2D::drawText(keybindTextPos, keybindName,
                                                     UIColor(255, 255, 255), textSize);
                            ...
                            case SettingType::SLIDER_S: {
                                ...
                                if(sliderSettingBase->valueType == ValueType::INT_T) {
                                    ...
                                    D2D::drawText(sTextPos, settingName + ":",
                                                         UIColor(255, 255, 255), textSize);
                                    D2D::drawText(
                                        valueTextPos, valueTextStr, UIColor(255, 255, 255),
                                        textSize, (draggingSliderSettingPtr != sliderSettingBase));
    ...
    if(showDescription && descriptionText != "NULL" && draggingWindowPtr == nullptr &&
       draggingSliderSettingPtr == nullptr) {
        ...
        Vec4<float> rectPos = Vec4<float>(
            ...
            mousePos.x + mousePadding.x + D2D::getTextWidth(descriptionText, 0.8f) +
                2.f * 2.f,
        ...
        D2D::drawText(textPos, lowerDesc, UIColor(255, 255, 255), 0.8f);
    }
}
