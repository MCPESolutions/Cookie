...
std::string GlobalConfig::clientVersion = "v1.4";
int GlobalConfig::clientBuildNumber = 100;
std::string GlobalConfig::clientname = "Cookie";

float GlobalConfig::fps = 0.0f;
float GlobalConfig::ping = 0.0f;
float GlobalConfig::deltaTime = 0.0f;

Color GlobalConfig::primaryColor(74, 144, 226);     // Blue
Color GlobalConfig::secondaryColor(51, 255, 187);   // Cyan
Color GlobalConfig::accentColor(255, 255, 255);     // White
